...
<template>
  ...
  <div class="spell-range-container">
    <input class="slider-thick" id="selectEarthquakeLevel" type="range" min="1" max="5" v-model="earthquakeLevel">
  </div>
</template>
...
.spell-image-container {
  width: 100px;
  height: 100px;
  filter: drop-shadow(24px 24px 48px #322E53);
  ...
  .spell-image {
    ...
    flex-shrink: 0;
    border-radius: 16px;
    box-shadow: -12px -8px 16px 0px #7D5A37 inset, 12px 8px 16px 0px #C09467 inset;
    filter: drop-shadow(24px 24px 48px #7D5A37);
    border: 3px solid #7D5A37;
...
.spell-range-container {
  ...
  .slider-thick::-webkit-slider-thumb {
    ...
    border-radius: 16px;
    background: $accent;
    box-shadow: -12px -8px 16px 0px #72640A inset, 12px 8px 16px 0px #C6AE0D inset;
    cursor: pointer;
  }
